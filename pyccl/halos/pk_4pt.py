...
def halomod_Tk3D_cNG(cosmo, hmc, prof, prof2=None, prof3=None, prof4=None,
    ...
    print('halomod_Tk3D_cNG: computing halomod_trispectrum_2h_22...')
    start_time = time.perf_counter()
    tkk += halomod_trispectrum_2h_22(cosmo, hmc, np.exp(lk_arr), a_arr,
                                     ...
                                     prof32_2pt=prof32_2pt,
                                     p_of_k_a=p_of_k_a)
    print(f'halomod_Tk3D_cNG: computing halomod_trispectrum_2h_22... done in {(time.perf_counter() - start_time)/60:.2f} m')

    print('halomod_Tk3D_cNG: computing halomod_trispectrum_2h_13...')
    start_time = time.perf_counter()
    tkk += halomod_trispectrum_2h_13(cosmo, hmc, np.exp(lk_arr), a_arr,
                                     ...
                                     prof34_2pt=prof34_2pt,
                                     p_of_k_a=p_of_k_a)
    print(f'halomod_Tk3D_cNG: computing halomod_trispectrum_2h_13... done in {(time.perf_counter() - start_time)/60:.2f} m')
